...
//  Check Out my GitHub at https://github.com/egadwiprasetya for more code and projects
...
int main() {
    ...
    if (benar == 1) {
        ...
        cout << "hasil konversi ke desimal : " << desimal<<"jumlah data didalam source data: "<<benar;
    } else cout << "data tidak ditemukan";
    cout << "\nTerimakasih \n\nCreated by Ega \nCopyright © 2016 Ega. All rights reserved.\nCheck Out my GitHub at https://github.com/egadwiprasetya for more code and projects"<<endl;
